...
case class DashboardBalance(date: Int, monthlyExpenses: Int)
...
case class DashboardWallet(id: Int, date: Int, name: String, category: String, currency: String, amount: Int, done: Boolean, account: String)
