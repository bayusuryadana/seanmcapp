...
class NewsServiceSpec extends AnyWordSpec with Matchers {
  ...
  "Scheduler" in {
    ...
    val expectedTitles = List(
      ...
      "The \"GameStop effect\" could ripple further",
    )
    val expectedUrl = List(
      ...
      "https://www.reuters.com/article/us-retail-trading-shorts/gamestop-effect-could-ripple-further-as-wall-street-eyes-short-squeeze-candidates-idUSKBN29X2MG",
    )
